...
INSERT INTO WorkEvaluations (
    ...
    -- employeeId: 12341 (최인사)
    (12341, 2025, 4, 5, 5, 4, 'A', 'T', '제출완료', 12345),
    (12341, 2025, 4, 5, 4, 5, 'A', 'T', '제출완료', 12347),
    (12341, 2025, 4, 4, 5, 5, 'A', 'T', '제출완료', 12348),
    (12341, 2025, 4, 5, 5, 5, 'A', 'T', '제출완료', 12358),

    -- employeeId: 12342 (박인턴)
    (12342, 2025, 4, 5, 5, 5, 'A', 'T', '제출완료', 12341),
    (12342, 2025, 4, 5, 4, 5, 'A', 'T', '제출완료', 12345),
    (12342, 2025, 4, 4, 5, 4, 'A', 'T', '제출완료', 12347),
    (12342, 2025, 4, 5, 5, 4, 'A', 'T', '제출완료', 12348),

    -- employeeId: 12343 (박책임)
    (12343, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 12341),
    (12343, 2025, 4, 4, 3, 4, 'B', 'T', '제출완료', 12345),
    (12343, 2025, 4, 3, 4, 3, 'C', 'T', '제출완료', 12347),
    (12343, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 12348),

    -- employeeId: 12345 (김수석)
    (12345, 2025, 4, 5, 5, 5, 'A', 'T', '제출완료', 12341),
    (12345, 2025, 4, 4, 5, 5, 'A', 'T', '제출완료', 12347),
    (12345, 2025, 4, 5, 5, 4, 'A', 'T', '제출완료', 12348),
    (12345, 2025, 4, 5, 4, 5, 'A', 'T', '제출완료', 12358),

    -- employeeId: 12347 (윤대리)
    (12347, 2025, 4, 5, 5, 5, 'A', 'T', '제출완료', 12341),
    (12347, 2025, 4, 5, 5, 4, 'A', 'T', '제출완료', 12345),
    (12347, 2025, 4, 5, 5, 5, 'A', 'T', '제출완료', 12348),
    (12347, 2025, 4, 5, 4, 5, 'A', 'T', '제출완료', 18061),

    -- employeeId: 12348 (홍선임)
    (12348, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 12341),
    (12348, 2025, 4, 4, 4, 3, 'B', 'T', '제출완료', 12345),
    (12348, 2025, 4, 3, 4, 4, 'B', 'T', '제출완료', 12347),
    (12348, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 12358),

    -- employeeId: 12358 (정사원)
    (12358, 2025, 4, 5, 5, 4, 'A', 'T', '제출완료', 12341),
    (12358, 2025, 4, 5, 4, 5, 'A', 'T', '제출완료', 12345),
    (12358, 2025, 4, 4, 5, 5, 'A', 'T', '제출완료', 12347),
    (12358, 2025, 4, 5, 5, 5, 'A', 'T', '제출완료', 12348),

    -- employeeId: 12396 (김선임)
    (12396, 2025, 4, 4, 4, 3, 'B', 'T', '제출완료', 12341),
    (12396, 2025, 4, 4, 3, 4, 'B', 'T', '제출완료', 12345),
    (12396, 2025, 4, 3, 4, 4, 'C', 'T', '제출완료', 12347),
    (12396, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 12348),

    -- employeeId: 18061 (송은우)
    (18061, 2025, 4, 5, 5, 4, 'A', 'T', '제출완료', 12341),
    (18061, 2025, 4, 5, 4, 5, 'A', 'T', '제출완료', 12345),
    (18061, 2025, 4, 5, 5, 5, 'A', 'T', '제출완료', 12347),
    (18061, 2025, 4, 4, 5, 5, 'A', 'T', '제출완료', 12348),

    -- employeeId: 102311 (이카페)
    (102311, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 12341),
    (102311, 2025, 4, 4, 3, 4, 'B', 'T', '제출완료', 12345),
    (102311, 2025, 4, 3, 4, 4, 'B', 'T', '제출완료', 12347),
    (102311, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 12348);

-- 인사팀 직원들의 4분기 평가 데이터 추가
INSERT INTO WorkEvaluations (
    employeeId, evaluation_year, evaluation_quarter,
    attitude_score, achievement_score, collaboration_score,
    contribution_grade, total_grade, status, evaluatorId
...
-- 👤 employeeId: 1 (최신입)
-- ================================
(1, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 12341),
(1, 2025, 4, 4, 5, 4, 'A', 'T', '제출완료', 12342),
(1, 2025, 4, 3, 4, 4, 'B', 'T', '제출완료', 12343),
(1, 2025, 4, 4, 4, 5, 'A', 'T', '제출완료', 12341),

-- ================================
-- 👤 employeeId: 12341 (최인사)
-- ================================
(12341, 2025, 4, 5, 5, 5, 'A', 'T', '제출완료', 12342),
(12341, 2025, 4, 4, 5, 5, 'A', 'T', '제출완료', 12343),
(12341, 2025, 4, 5, 4, 5, 'A', 'T', '제출완료', 1),
(12341, 2025, 4, 5, 5, 4, 'A', 'T', '제출완료', 12342),

-- ================================
-- 👤 employeeId: 12342 (박인턴)
-- ================================
(12342, 2025, 4, 5, 5, 5, 'A', 'T', '제출완료', 12341),
(12342, 2025, 4, 4, 5, 4, 'A', 'T', '제출완료', 12343),
(12342, 2025, 4, 5, 4, 5, 'A', 'T', '제출완료', 1),
(12342, 2025, 4, 4, 5, 5, 'A', 'T', '제출완료', 12341),

-- ================================
-- 👤 employeeId: 12343 (박책임)
-- ================================
(12343, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 12341),
(12343, 2025, 4, 3, 4, 3, 'C', 'T', '제출완료', 12342),
(12343, 2025, 4, 4, 4, 4, 'B', 'T', '제출완료', 1),
(12343, 2025, 4, 4, 3, 4, 'B', 'T', '제출완료', 12341);
